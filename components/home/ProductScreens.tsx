    ...
    <section id="productscreens">
      <Container className="text-center">
        ...
        <div className="relative flex justify-center w-[150%] md:w-full -translate-x-[16.67%] md:translate-x-0 mb-4 md:mb-4">
          ...
          <div
            className="aspect-video rounded-lg md:rounded-2xl relative w-[55%] overflow-hidden shadow-[0_40px_50px_50px_rgba(22,23,24,0.9)] md:shadow-[0_80px_100px_100px_rgba(22,23,24,0.9)] backdrop-blur-lg"
            style={{
              background:
